...
var _assetsApps0000_70_dns_01DnsDaemonsetYaml = []byte(`kind: DaemonSet
apiVersion: apps/v1
metadata:
  labels:
...
func assetsApps0000_70_dns_01DnsDaemonsetYamlBytes() ([]byte, error) {
	return _assetsApps0000_70_dns_01DnsDaemonsetYaml, nil
}

func assetsApps0000_70_dns_01DnsDaemonsetYaml() (*asset, error) {
	bytes, err := assetsApps0000_70_dns_01DnsDaemonsetYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "assets/apps/0000_70_dns_01-dns-daemonset.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _assetsApps0000_70_dns_01NodeResolverDaemonsetYaml = []byte(`apiVersion: apps/v1
kind: DaemonSet
metadata:
  name: node-resolver
  namespace: openshift-dns
...
func assetsApps0000_70_dns_01NodeResolverDaemonsetYamlBytes() ([]byte, error) {
	return _assetsApps0000_70_dns_01NodeResolverDaemonsetYaml, nil
}

func assetsApps0000_70_dns_01NodeResolverDaemonsetYaml() (*asset, error) {
	bytes, err := assetsApps0000_70_dns_01NodeResolverDaemonsetYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "assets/apps/0000_70_dns_01-node-resolver-daemonset.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
